<%@ Page Title="" Language="C#" MasterPageFile="~/portfolio/Site1.Master" AutoEventWireup="true" CodeBehind="homepage.aspx.cs" Inherits="PortfolioBuilder.portfolio.homepage" %>
   		...
   		<div class="row">
   			...
   			<div class="col-twelve">
	   			...
	   			<p class="intro-position">
	   				<span runat="server" id="expertise"></span>
	   			</p>
   ...
   <section id="about">  
   	...
   	<div class="row section-intro">
   		<div class="col-twelve">
   			...
   			<div class="intro-info">
   				<img src="images/profile-pic.jpg" runat="server" id="profile_img" alt="Profile Picture">

   				<p class="lead" runat="server" id="info">Lorem ipsum Exercitation culpa qui dolor consequat exercitation fugiat laborum ex ea eiusmod ad do aliqua occaecat nisi ad irure sunt id pariatur Duis laboris amet exercitation veniam labore consectetur ea id quis eiusmod.</p>
   			</div>   			
   		</div>   		
   	</div> <!-- /section-intro -->
   		...
   		<div class="col-six tab-full">
   			...
   			<ul class="info-list">
   				<li>
   					...
   					<span runat="server" id="fullname">Juan Dela Cruz</span>
   				</li>
   				<li>
   					<strong>Birth Date:</strong>
   					<span runat="server" id="dob">September 28, 1987</span>
   				</li>
   				<li>
   					<strong>Job:</strong>
   					<span runat="server" id="job">Freelancer, Frontend Developer</span>
   				</li>
   				<li>
   					<strong>Website:</strong>
   					<span runat="server" id="website">www.kardswebsite.com</span>
   				</li>
   				<li>
   					<strong>Email:</strong>
   					<span runat="server" id="mail">me@kardswebsite.com</span>
   				</li>
   	...
   	<div class="row button-section">
   		<div class="col-twelve">
               ...
               <div runat="server" id="resumeDownload">    </div>
   		</div>   		
   	</div>
